<html>
	<head>
		...
		<style>
			...
			#result-code { white-space: normal; }
		</style>
	...
	<body>
		<pre class="cm-s-default"><code><span class="cm-keyword">const</span> <span class="cm-variable-2">code</span> <span class="cm-operator">=</span> <span class="cm-string">"<script>document.write(code)</script>"</span>;</code></pre>
...
return code + ' is a code that needs to be cracked';</textarea>}
		</code></pre>
